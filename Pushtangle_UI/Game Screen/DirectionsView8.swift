    ...
    var body: some View {
        if #available(iOS 16.0, *) {
            NavigationStack{
                ...
                Text("Click the 2 circled buttons. These 2 buttons move the SHAPES and NUMBERS \n in that row left/right.")
                ...
                .toolbar{
                    ...
                    ToolbarItem(placement: .navigationBarTrailing){
                        Button(action: {
                            ...
                            HStack(spacing: 3.0){
                                NavigationLink(destination: DirectionsView9()) {
                                    Text("Next")
                                }
...
struct DirectionsView8_Previews: PreviewProvider {
