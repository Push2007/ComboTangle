        ...
        var body: some View {
            if #available(iOS 16.0, *) {
                NavigationStack{
                    ...
                    Text("Click the 2 circled buttons. These 2 buttons move the COLORS in that column \n up/down.")
                    ...
                    .toolbar{
                        ...
                        ToolbarItem(placement: .navigationBarTrailing){
                            Button(action: {
                                ...
                                HStack(spacing: 3.0){
                                    NavigationLink(destination: DirectionsView6()) {
                                        Text("Next")
                                    }
...
struct DirectionsView5_Previews: PreviewProvider {
