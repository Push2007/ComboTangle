    ...
    var body: some View {
        if #available(iOS 16.0, *) {
            NavigationStack{
                ...
                Text("Click the 2 circled buttons. These 2 buttons move the COLORS and NUMBERS \n in that row left/right.")
                ...
                .toolbar{
                    ...
                    ToolbarItem(placement: .navigationBarTrailing){
                        Button(action: {
                            ...
                            HStack(spacing: 3.0){
                                NavigationLink(destination: DirectionsView10()) {
                                    Text("Next")
                                }
...
struct DirectionsView9_Previews: PreviewProvider {
